...
//STOCK COUNT WAS A TYPO
/*STOCK COUNT DOES NOT EXIST AS A VARIABLE SO IF I RUN THIS IF/ELSE STATEMENT
IT THROWS AN ERROR, BUT IF I SET stockCount = to inStock then it runs fine*/
...
var vegetables = ['carrots', 'broccoli', 'cauliflower', 'onion', 'bell peppers'];
...
var fruits = ['pineapple', 'cucumber', 'watermelon', 'pear', 'canteloupe', 'peach', 'blueberry'];
